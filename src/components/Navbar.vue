  ...
  <nav ref="navbar" class="fixed top-0 left-0 w-full bg-primary-200 z-20 transition duration-200"> 
    <div class="container flex items-center justify-between h-20">
      <div class="relative z-30 flex items-center gap-2 mb-2 lg:mb-0">
        <h1 class="text-white font-bold text-lg lg:text-2xl">Gro<span class="text-secondary">ceri</span>es</h1>
      </div>
      <div class="flex lg:hidden items-center gap-2">
        <button class="relative z-30 px-4 py-2 -mt-1.5 text-sm rounded-full text-white font-medium tracking-wider uppercase bg-secondary w-full lg:w-auto">Order now</button>
      ...
      >
        ...
        <a @click="showMenu = false" class="text-white font-medium" href="#types">Types</a>
        <a @click="showMenu = false" class="text-white font-medium" href="#recipes">Recipes</a>
        <button class="hidden md:block px-8 py-3 rounded-full text-white font-medium tracking-wider uppercase bg-secondary w-full lg:w-auto">Order</button>
      </div>
    </div>
  </nav>
</template>
